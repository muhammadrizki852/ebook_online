...
<body>
    <div class="container no-print mb-4">
        <div class="alert alert-info d-flex justify-content-between align-items-center">
            <span>Pratinjau laporan transaksi. Gunakan tombol di samping untuk menyimpan sebagai PDF.</span>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-4">
            <div class="stat-box">
                ...
                <div class="stat-value">{{ number_format($paidTransactions) }}</div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="stat-box">
    ...
    <h5 class="fw-bold mb-3">Transaction Activities</h5>
        ...
        <tbody>
            @forelse($activities as $activity)
                <tr>
                    ...
                    <td class="text-end">Rp {{ number_format($activity->amount ?? $activity->ebook?->price ?? 0, 0, ',', '.') }}</td>
                </tr>
            @empty
                <tr>
                    <td colspan="8" class="text-center py-5 text-muted">No transaction activities found for this period.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
