            ...
            <div class="collapse navbar-collapse" id="mainNavMenu">
                ...
                <ul class="navbar-nav me-auto align-items-lg-center gap-lg-1 mt-2 mt-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link-custom dropdown-toggle {{ request()->routeIs('manual-book.*') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Help
                        </a>
                        <ul class="dropdown-menu border-0 shadow" style="border-radius:12px;">
                            <li>
                                <a class="dropdown-item" href="{{ route('manual-book.show') }}">
                                    <i class="bi bi-file-earmark-pdf me-2 text-accent"></i>Manual Book
                                </a>
                            </li>
                        </ul>
                    </li>
