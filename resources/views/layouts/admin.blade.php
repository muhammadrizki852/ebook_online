...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="sidebar-section mt-2">Reports</div>
            <a href="{{ route('admin.payments.report') }}" class="sidebar-link {{ request()->routeIs('admin.payments.report') ? 'active' : '' }}">
                <i class="bi bi-graph-up-arrow"></i> Sales Report
            </a>
            <a href="{{ route('admin.reports.users') }}" class="sidebar-link {{ request()->routeIs('admin.reports.users') ? 'active' : '' }}">
                <i class="bi bi-person-lines-fill"></i> User Report
            </a>
            <a href="{{ route('admin.reports.ebooks') }}" class="sidebar-link {{ request()->routeIs('admin.reports.ebooks') ? 'active' : '' }}">
                <i class="bi bi-journals"></i> Ebook Report
            </a>
            <a href="{{ route('admin.reports.transactions') }}" class="sidebar-link {{ request()->routeIs('admin.reports.transactions') ? 'active' : '' }}">
                <i class="bi bi-receipt"></i> Transaction Report
            </a>

            <div class="sidebar-section mt-2">Help</div>
            <a href="{{ route('admin.manual-books.index') }}" class="sidebar-link {{ request()->routeIs('admin.manual-books.*') ? 'active' : '' }}">
